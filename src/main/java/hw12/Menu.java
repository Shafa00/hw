            ...
            switch (option){
                ...
                case "6":
                    try {
                        ...
                        familyController.createNewFamily(new Woman(motherName, motherLname, motherBirth, motherIq), new Man(fatherName, fatherLname, fatherBirth, fatherIq));
